/**
 * Performs a scroll inside the window to a specific position, for a specific duration.
 * @param {Element} destination - The DOM element to scroll to.
 * @param {Number} duration - The duration of the animation, should be between 0 and 5000.
 * @param {String} easing - The animation effect to use.
 */
export default function scrollTo(destination, duration = 200, easing = 'linear', callback) {
  const easings = {
    ...
    easeOutQuart(t) { return 1 - ((((t -= 1) * t) * t) * t); },
    easeInOutQuart(t) {
      return t < 0.5 ? 8 * t * t * t * t : 1 - ((((8 * (t -= 1)) * t) * t) * t);
    },
    easeInQuint(t) { return t * t * t * t * t; },
    easeOutQuint(t) { return 1 + (((((t -= 1) * t) * t) * t) * t); },
    easeInOutQuint(t) {
